...
class Home extends Officer_Controller {
	...
	public function index()
	{
		...
		$this->data["livable_house_count"] 	= $this->housing_model->count_houses_by_category( 1, $village_id );
		$this->data["unlivable_house_count"] = $this->housing_model->count_houses_by_category( 0, $village_id );
		#################################################################3
